/* ============================================================
   ...
   Last sync: 2026-06-02 · Auto-deploy via GitHub → Vercel
   ============================================================ */
...
/* ---------- 访问控制：官网成员名片对公众模糊，凭邀请码解锁 ----------
   逻辑：路人看到的核心成员名片是「模糊+隐去社交跳转」的（保留头衔做钩子）；
   入会后我们发邀请码，会员在「核心成员」区输入即可解锁查看全员姓名+社交跳转（记在本机浏览器）。
   纯前端软门槛(非加密)，只为"先入会再看全貌"的引导。 */
window.FFC_ACCESS = {
  unlockCodes: ['FFC-MEMBER'],   // ← 改成你要发给会员的真实邀请码（可多个）
};

/* ---------- 增值服务（VIP0 入会之上的月费项，定价区展示） ---------- */
window.FFC_VALUE_SERVICES = [
  { tier: 'VIP1', name: '推特投研研报',         price: '¥199/月', desc: '核心博主推文 AI 解析 · 立场 / 置信度 / 标的' },
  { tier: 'VIP2', name: '大佬引荐 · 发起人背书', price: '¥699/月', desc: '每月 3 个引荐名额 · 发起人亲自背书' },
  { tier: '加购', name: '政客研报（单独）',       price: '¥99/月',  desc: '政策 / 政商动向专题研报' },
  { tier: '加购', name: '推特 ＋ 政客 打包',       price: '¥249/月', desc: '两份研报打包订阅，更划算' },
];
